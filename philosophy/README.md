...
| --- | --- | --- |
| 1 | [The Orchestrator Principle](01-orchestrator-principle.md) | The orchestrator controls the tools. The orchestrator does not do the tools' work. |
| 2 | [Files Over Memory](02-files-over-memory.md) | If the file does not exist, the knowledge does not exist. |
| 3 | [The Three Layers of State](03-three-layers-of-state.md) | Permanent, Active, Idea — three timescales, three write protocols, never mixed. |
